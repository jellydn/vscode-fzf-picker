...
| `fzf-picker.general.cacheDirectory`                    | Custom directory for cache files. If empty, uses platform-specific default location. Supports environment variable expansion.                                                          | `string`  | `""`                                                                                     |
| `fzf-picker.general.enableCache`                       | Enable or disable cache functionality entirely. When disabled, no cache files will be created or used.                                                                                 | `boolean` | `true`                                                                                   |
