...
| `fzf-picker.general.terminalLocation`                  | Where to show the terminal when running fzf commands.                                                                                                                                                                                                                                                                                             | `string`  | `"editor"`                                                                               |
| `fzf-picker.general.shellArgsForTerminal`              | Set the args for the shell (terminal type) to be used. Example: ["-l"] for a login shell.                                                                                                                                                                                                                                                         | `array`   | `null`                                                                                   |
